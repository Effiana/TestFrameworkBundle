...
namespace Effiana\TestFrameworkBundle\BehatStatisticExtension\Features\Context;
...
use Effiana\TestFrameworkBundle\BehatStatisticExtension\ServiceContainer\BehatStatisticExtension;
