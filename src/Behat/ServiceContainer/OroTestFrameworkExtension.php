...
namespace Effiana\TestFrameworkBundle\Behat\ServiceContainer;
...
use Effiana\TestFrameworkBundle\Behat\Artifacts\ArtifactsHandlerInterface;
use Effiana\TestFrameworkBundle\Behat\Driver\EffianaSelenium2Factory;
use Effiana\TestFrameworkBundle\Behat\Driver\EffianaWebDriverCurlService;
...
class OroTestFrameworkExtension implements TestworkExtension
{
    ...
    public function initialize(ExtensionManager $extensionManager)
    {
        ...
        $minkExtension->registerDriverFactory(new EffianaSelenium2Factory());
    }
    ...
    {
        $curl = new EffianaWebDriverCurlService();
    ...
    private function replaceSessionListener(ContainerBuilder $container)
    {
        $container
            ...
            ->setClass('Effiana\TestFrameworkBundle\Behat\Listener\SessionsListener');
    }
