...
use Effiana\TestFrameworkBundle\Entity\TestActivity;

class TestActivityActivityListProvider implements ActivityListProviderInterface
{
    const ACTIVITY_CLASS = 'Effiana\TestFrameworkBundle\Entity\TestActivity';
    const ACL_CLASS = 'Effiana\TestFrameworkBundle\Entity\TestActivity';
