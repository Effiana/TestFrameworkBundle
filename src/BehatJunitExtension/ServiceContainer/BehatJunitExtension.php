...
namespace Effiana\TestFrameworkBundle\BehatJunitExtension\ServiceContainer;
...
class BehatJunitExtension implements TestworkExtension
{
    ...
    public function process(ContainerBuilder $container)
    {
        $definition = new Definition(
            'Effiana\TestFrameworkBundle\BehatJunitExtension\EventListener\JUnitDurationListener'
        );
        ...
        $junitFeaturePrinter->setClass(
            'Effiana\TestFrameworkBundle\BehatJunitExtension\Output\Printer\JUnitFeaturePrinter'
        );
        ...
        $junitScenarioPrinter->setClass(
            'Effiana\TestFrameworkBundle\BehatJunitExtension\Output\Printer\JUnitScenarioPrinter'
        );
        ...
        $definition = new Definition(
            ...
            [[
                ...
                new Definition(
                    'Effiana\TestFrameworkBundle\BehatJunitExtension\EventListener\JUnitFeatureElementListener',
                    [
