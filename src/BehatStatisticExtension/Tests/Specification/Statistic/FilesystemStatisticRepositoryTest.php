...
namespace Effiana\TestFrameworkBundle\BehatStatisticExtension\Tests\Specification\Statistic;

use Effiana\TestFrameworkBundle\BehatStatisticExtension\Specification\Statistic\FilesystemStatisticRepository;
