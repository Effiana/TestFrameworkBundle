...
namespace Effiana\TestFrameworkBundle\Tests\Behat\Context;
...
use Effiana\TestFrameworkBundle\Behat\Context\AssertTrait;
use Effiana\TestFrameworkBundle\Behat\Context\SessionAliasProviderAwareInterface;
use Effiana\TestFrameworkBundle\Behat\Context\SessionAliasProviderAwareTrait;
use Effiana\TestFrameworkBundle\Behat\Driver\EffianaSelenium2Driver;
use Effiana\TestFrameworkBundle\Behat\Element\CollectionField;
use Effiana\TestFrameworkBundle\Behat\Element\Element;
use Effiana\TestFrameworkBundle\Behat\Element\Form;
    ...
    MessageQueueIsolatorAwareInterface
{
    ...
    public function beforeStep(BeforeStepScope $scope)
    {
        ...
        /** @var EffianaSelenium2Driver $driver */
     ...
     * @see \Effiana\TestFrameworkBundle\Tests\Behat\Context\OroMainContext::switchToActorWindowSession
     *
    ...
    public function iShouldSeeButtonWithAttributes($buttonName, TableNode $table)
    {
        ...
        if (null === $button) {
            /* @var $driver EffianaSelenium2Driver */
            $driver = $this->getSession()->getDriver();
     ...
     * @see \Effiana\TestFrameworkBundle\Tests\Behat\Context\OroMainContext::iOperateAsActorUnderSession
     * @see \Effiana\TestFrameworkBundle\Tests\Behat\Context\OroMainContext::sessionsInit
     * @see \Effiana\TestFrameworkBundle\Tests\Behat\Context\OroMainContext::loginAsUserWithPasswordInSession
