...
namespace Effiana\TestFrameworkBundle\BehatStatisticExtension\ServiceContainer\Formatter;
...
use Effiana\TestFrameworkBundle\BehatStatisticExtension\EventListener\FeatureStatisticSubscriber;
use Effiana\TestFrameworkBundle\BehatStatisticExtension\Output\Printer\NullOutputPrinter;
...
final class StatisticFormatterFactory implements FormatterFactory
{
    ...
    private function defineStatisticModels(ContainerBuilder $container)
    {
        $container->setParameter(
            ...
            [
                'Effiana\TestFrameworkBundle\BehatStatisticExtension\Model\FeatureStatistic',
            ]
        );
    }
